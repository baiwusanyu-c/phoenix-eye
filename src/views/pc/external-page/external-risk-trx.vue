/* * @external-risk-trx.vue * @deprecated 提供给外部的风险交易列表 * @author czh * @update (czh
2022/3/11) */
<template>
    ...
    <be-container>
      <be-header height="60px">
        <div class="external-header">
          ...
          <div class="external-select">
            ...
            <el-select
              v-model="curPlatform"
              style="float: right; width: 120px; margin-right: 30px"
              @change="handleSelect">
              <el-option
      ...
      <be-main class="external-risk-trx--main">
        <risk-trx-table
          ...
          :show-pager="false"
          :filter-chain-item="filterChainItem"></risk-trx-table>
      </be-main>
    </be-container>
  </div>
</template>
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const platformList = platformListDict.concat([
        { label: 'ALL', value: 'all', id: 'qwdgsnldjaktg' },
      ])
      /**
       * 處理選擇事件
