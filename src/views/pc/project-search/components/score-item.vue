...
<script lang="ts">
  ...
  import ScoreCell from '../../../../components/common-components/score-cell/score-cell.vue'
  import type { PropType } from 'vue'
  import type { IScoreItems } from '../../../../utils/types'
...
<style lang="scss">
  ...
  .score-item {
    ...
    .be-progress .be-progress-circle .be-progress-circle--text {
      text-align: center;
    }
    p {
      font-size: 18px;
