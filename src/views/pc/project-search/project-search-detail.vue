...
<template>
    <div class="project-search-detail">
        ...
        <div v-loading="baseLoading" class="proj-detail-item" style="margin-top: 32px">
            <div class="item-title" style="width: 100%;position: relative">
                <h2>
                    <be-ellipsis-copy
            ...
            "
                ...
                <span style="margin-right: 30px; font-size: 14px; font-weight: bold; color: #333">{{isEmpty(baseInfo.riksTrxNum)}}</span>
                <span style="margin-right: 6px">{{ $t('lang.projectExplorer.detail.riskPublicOpinion') }}(24h) :</span>
                <span style="margin-right: 16px; font-size: 14px; font-weight: bold; color: #333">{{
                        isEmpty(baseInfo.riskPublicOpinion)
                    }}</span>
                <be-button  custom-class="eagle-btn subscribe--btn subscribe-btn-ed"
                            @click="submitSubscribe"
                            prevIcon="iconStarEagle"
                            type="success">
