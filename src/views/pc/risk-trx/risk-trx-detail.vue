  ...
  <div v-loading="loading" class="risk-trx-detail">
        ...
        <div class="detail-item-txt detail-item--hash" >
          ...
          <div class="detail-item-txt detail-item--date" >
              ...
              <el-tooltip placement="top" effect="light">
                  <template #content>
                      <span style="font-weight: 400">UTC：{{ beijing2utc('2022-03-17T12:27:53.000+0000') }}</span>
                  </template>
    ...
    <div v-if="profitData.length > 0" class="detail-profit">
      ...
      <div class="detail-slump">
          <div class="detail-slump--container" v-if="baseInfo.slump">
          ...
          <div class="detail-slump--container" v-if="baseInfo.slump">
              ...
              <div class="detail-slump--body">
                  ...
                  <div style="display: flex;margin-top: 20px;align-items: center">
                      <span class="label">{{ $t('lang.riskConfig.presentPrice') }} :
                      </span>
                      <span style="font-weight: bold;width: 160px">{{ handleProfit(baseInfo.slump.value, 0) }}</span>
                      <span :class="baseInfo.slump.profit > 0 ? 'profit-x' : 'profit-d'" style="font-weight: bold;margin-right: 6px">
...
<script lang="ts">
  ...
  import { getUuid, simulateToFixed, openWindow,beijing2utc,formatDate,createDate } from '../../../utils/common'
