...
export default {
  ...
  projectExplorer: {
    ...
    detail: {
      ...
      scoreItem1: 'Audit Report',
      scoreItemDesc1: 'The status and results of the project being audited.',
      scoreItem2: 'Decentralization',
      scoreItemDesc2: 'Whale holder distribution and privileges.',
      scoreItem3: 'Market Volatility',
      scoreItemDesc3: 'Price and transaction status.',
      scoreItem4: 'Transparency & Governance',
      scoreItemDesc4: 'Information disclosure and business process.',
      scoreItem5: 'Risk Transacions',
      scoreItemDesc5: 'On-chain abnormal behaviors.',
